...
<br/><br/>
***Virtual Wifi Hotspot To Block Amazon OTA Updates Example(CLI Version, modifies HOSTS file and launches Hotspot -IN TESTING-):***
...
<br/><br/>
***HOSTS File Modification AGGRESSIVE Example (Will FAIL Update Check):***
